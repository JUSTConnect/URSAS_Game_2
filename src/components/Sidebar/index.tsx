...
const Sidebar = () => {
    ...
    const buttons = [
        ...
        {
            href: game.walletConnected && game.currentRoom !== 0 ? `/tables/${game.currentRoom}` : {},
        ...
        {
            href: game.walletConnected && game.currentGame !== 0 ? `/table/${game.currentGame}` : {},
        ...
        <div className={ css.container }>
            <div className={ css.card }>
                ...
                <div className={ [css.section, css.links].join(' ') }>
                    ...
                    <Link className={ css.link } href='https://ursas.gitbook.io/ursas-game/'>Rules</Link>
                </div>
            </div>
        </div>
    </>
