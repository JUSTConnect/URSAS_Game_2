...
const Sidebar = () => {
  ...
  const buttons = [
    ...
    {
      href: router?.query?.room && router?.query?.table ? `/tables/${router?.query?.room}/table/${router?.query?.table}` : {},
      icon: <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_669_5312)">
          <path
            d="M4.25012 7.4V9H11.7501V7.4C11.7501 5.912 12.7101 4.672 14.0001 4.312V3.4C14.0001 2.08 12.9876 1 11.7501 1H4.25012C3.01262 1 2.00012 2.08 2.00012 3.4V4.312C3.29012 4.672 4.25012 5.912 4.25012 7.4Z"
            fill="#4E5E80"/>
          <path
            d="M14.5456 6C13.7456 6 13.091 6.675 13.091 7.5V10.5H2.90921V7.5C2.90921 6.675 2.25467 6 1.45467 6C0.654668 6 0.00012207 6.675 0.00012207 7.5V11.25C0.00012207 12.4875 0.98194 13.5 2.18194 13.5V14.25C2.18194 14.6625 2.50921 15 2.90921 15C3.30921 15 3.63649 14.6625 3.63649 14.25V13.5H12.3638V14.25C12.3638 14.6625 12.691 15 13.091 15C13.491 15 13.8183 14.6625 13.8183 14.25V13.5C15.0183 13.5 16.0001 12.4875 16.0001 11.25V7.5C16.0001 6.675 15.3456 6 14.5456 6Z"
            fill="#4E5E80"/>
        </g>
        <defs>
