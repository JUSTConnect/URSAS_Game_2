      ...
      >
        <Info>
          <div className={css.infoContent}>
            <div>
              Base time: <span className={'textPrimary'}>{ roomCurrent && roomCurrent?.roomDuration / 3600}</span>
            </div>
            <div>
              Increase time: <span className={'textPrimary'}>{ roomCurrent && roomCurrent.roomDuration / 3600 }</span>
            </div>
            <div>
